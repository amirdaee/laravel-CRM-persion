...
return [
    ...
    */
    ...
    'email'                => 'باید :attribute معتبر وارد کنید.',
    ...
    'min'                  => [
        'numeric' => ':attribute باید بیشتر از :min.',
        'file'    => ':attributeباید بیشتر از  :min کیلوبایت باشد.',
        'string'  => ':attribute باید بیشتر از  :min کاراکتر باشد.',
        'array'   => ':attribute must have at least :min آیتم باشد.',
    ],
    ...
    */
    ...
    'attributes' => array(
        ...
        'body'=>'مطلب',
        'to_date'=>'تاریخ',
        'from_time'=>'ساعت شروع مرخصی',
        'to_time'=>'ساعت پایان مرخصی',
        'vacation_1'=>'روز اول',
